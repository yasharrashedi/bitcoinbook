...
کاربران می‌توانند بیتکوین را در شبکه برای انجام تقریباً هر چیزی که با پول‌های مرسوم می‌توان انجام داد، منتقل نمایند. از این موارد می‌توان به خرید و فروش کالا،‌ارسال پول به افراد و سازمان ها یا افزایش اعتبار اشاره کرد. بیتکوین امکان خریداری شدن،‌فروخته شدن یا مبادله شدن به ازای سایر ارزها را در صرافی‌های مخصوصی دارد. به تعبیری بیتکوین، یک شکل کامل پول برای اینترنت است به این علت که سریع، امن و بدون مرز است.
