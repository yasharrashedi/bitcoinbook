...
((("bitcoin", "defined", id="GSdefine01")))بیتکوین مجموعه‌ای از مفاهیم و تکنولوژی‌ها است که مبنای یک اکوسیستم پول دیجیتال را تشکیل می دهد. واحدهای این ارز که بیتکوین نام دارند برای ذخیره و انتقال ارزش در بین مشارکت‌کنندگان  شبکه بیتکوین مورد استفاده قرار می‌گیرد. کاربران بیتکوین با یکدیگر توسط پرتکل بیتکوین و عموما از طریق اینترنت ارتباط برقرار می‌کنند، اگرچه سایر شبکه‌های انتقال نیز قابل استفاده است. مجموعه پروتکل بیتکوین که به صورت نرم‌افزار متن‌باز در دسترس است، امکان اجرا بر روی بازه وسیعی از دستگاه‌های رایانه‌ای، شامل لپتاپ‌ها و تلفن‌های هوشمند را دارد که در دسترس قرار گرفتن این تکنولوژی را به سادگی را امکانپذیر می ‌نماید.
